...
class AccountTest {
    ...
    void createAccount() {
        ...
        account =new Account("ucj", "boyomichaelbidemi@gmail.com","2323");
        assertEquals(1002, account.getAccountNumber());
    ...
    @Test
    void accountTypeSavings() {
        Account account = new Account("Michael", "Michael Boyo", "1234");
        assertEquals(account.getAccountType(), "SAVINGS");
    }

    @Test
    void accountTypeCurrent() {
        Account account = new Account("Michael", "Michael Boyo", "1234");
